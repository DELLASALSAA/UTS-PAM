...
const Detail = ({ route, navigation }) => {
    ...
    const scheduleList = JADWAL.filter(item =>
        item.dermaga_keberangkatan === data.berangkat &&
        ...
        <SafeAreaView style={styles.container}>
          <View style={styles.main}>
              ...
              renderItem={({ item }) => (
                <View style={styles.card}>
                  <TouchableOpacity style={styles.detail_search}>
                    ...
                    <View style={styles.detail_style}>
                      <Text style={styles.text}>Dewasa x 2</Text>
                      <Text style={styles.text}>Rp.60.000,00</Text>
                    </View>
                  </TouchableOpacity>
                </View>
              )}
            ...
            <View style={styles.result_style}>
              ...
              <Text style={styles.textResult}>Rp.60.000</Text>
            </View>
